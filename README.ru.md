...
> Скилл для Codex и Claude Code, который превращает сырой запрос в понятный execution pack и спрашивает подтверждение перед запуском.
...
- для пользователей Codex и Claude Code, которые хотят меньше тех-шума и больше ясности
